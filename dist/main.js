...
var map = {
	...
	"./account-transaction/account-transaction.module": [
		"./src/app/pages/account-transaction/account-transaction.module.ts",
		"default~account-transaction-account-transaction-module~cash-payment-cash-payment-module~cash-payment~864d396a",
		"common",
		"account-transaction-account-transaction-module"
	],
	"./cash-payment-status/cash-payment-status.module": [
		"./src/app/pages/cash-payment-status/cash-payment-status.module.ts",
		"default~account-transaction-account-transaction-module~cash-payment-cash-payment-module~cash-payment~864d396a",
		"common",
		"cash-payment-status-cash-payment-status-module"
	],
	"./cash-payment/cash-payment.module": [
		"./src/app/pages/cash-payment/cash-payment.module.ts",
		"default~account-transaction-account-transaction-module~cash-payment-cash-payment-module~cash-payment~864d396a",
		"common",
		"cash-payment-cash-payment-module"
	],
	"./cash-request-status/cash-request-status.module": [
		"./src/app/pages/cash-request-status/cash-request-status.module.ts",
		"default~account-transaction-account-transaction-module~cash-payment-cash-payment-module~cash-payment~864d396a",
		"common",
		"cash-request-status-cash-request-status-module"
	],
	"./cash-request/cash-request.module": [
	...
	"./financial-institution/financial-institution.module": [
		"./src/app/pages/financial-institution/financial-institution.module.ts",
		"default~account-transaction-account-transaction-module~cash-payment-cash-payment-module~cash-payment~864d396a",
		"common",
		"financial-institution-financial-institution-module"
	],
	"./interest-percentage/interest-percentage.module": [
...
var routes = [
    { path: '', loadChildren: './login/login.module#LoginModule', canActivate: [_shared__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_shared__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]],
...
module.exports = __webpack_require__(/*! C:\Users\hp\Desktop\VidiyalUI-master\VidiyalUI-master\src\main.ts */"./src/main.ts");
