...
@NgModule({
  declarations: [CashPaymentComponent, CashPaymentAddComponent, CashPaymentEditComponent, CashPaymentDeleteComponent, CashPaymentViewComponent, CashPaymentListComponent],
  imports: [
    CommonModule,
